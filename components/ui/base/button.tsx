  ...
  'inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        // 语义化配色系统
        primary: 'bg-claude-orange-500 hover:bg-claude-orange-600 text-white shadow-xs',
        success: 'bg-emerald-500 hover:bg-emerald-600 text-white shadow-xs',
        warning: 'bg-amber-500 hover:bg-amber-600 text-white shadow-xs',
        danger: 'bg-red-500 hover:bg-red-600 text-white shadow-xs',
        info: 'bg-claude-orange-500 hover:bg-claude-orange-600 text-white shadow-xs',
        // 原有变体（保持兼容）
        destructive: 'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline: 'border border-input bg-background hover:bg-accent hover:text-accent-foreground',
        secondary: 'bg-claude-cream-100 hover:bg-claude-cream-200 text-claude-dark-900',
